...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el atleta por nombre");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 * Le muestra el usuario el país que representa el atleta
	 */
	private void ejecutarAtletaPorNombre()
	{
		...
		Atleta atletaEncontrado = calculadora.buscarAtleta(nombreAtleta);
		if (atletaEncontrado != null)
		{
			Pais paisAtleta = atletaEncontrado.darPais();
			System.out.println("El atleta " + nombreAtleta + "representa el país " + paisAtleta.darNombre());
		}
		else
		{
